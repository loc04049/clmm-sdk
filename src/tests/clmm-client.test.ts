...
describe('ClmmClient', () => {
  ...
  it('create CLMM pool', async () => {
    ...
    const { price: priceMin } = getTokenATokenBAndPrice(mint1, mint2, new Decimal(0.1))
    const { price: priceMax } = getTokenATokenBAndPrice(mint1, mint2, new Decimal(10))
